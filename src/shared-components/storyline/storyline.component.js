...
export const StoryLineProfessionalComponent = props => {
  return (
    <div className="storyline">
      ...
      />
      <div style={{ marginTop: '60px', cursor: 'pointer' }} className="storyline__circle" />
      <StoryComponent
        color="#52BBEB"
      ...
      <StoryComponent
        ...
        description="Working widely throughout the IoT development range, from device level communication to a Dashboard Web App, making sure the connection between the devices and cloud, which can be made in many different ways, is smooth and reliable.
"
        orientation="left"
        label={'OCT 2019 - NOW'}
      />
